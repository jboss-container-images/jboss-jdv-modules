...
source $BATS_TEST_DIRNAME/../../os-datavirt/added/launch/security-ldap.sh

@test "do not configure security domain when URL is not provided" {
...
@test "configure security domain by minimum xml content when URL is provided" {
    cp $BATS_TEST_DIRNAME/resources/standalone-openshift.xml $CONFIG_FILE
    run unset_security_ldap_env
...
@test "configure security domain with all LDAP values when provided" {
    cp $BATS_TEST_DIRNAME/resources/standalone-openshift.xml $CONFIG_FILE
    run unset_security_ldap_env

    DEFAULT_SECURITY_DOMAIN="test-all-ldap"
    AUTH_LDAP_URL="test AUTH_LDAP_URL"

    AUTH_LDAP_ALLOW_EMPTY_PASSWORDS="test AUTH_LDAP_ALLOW_EMPTY_PASSWORDS"
    AUTH_LDAP_AUTHENTICATION="test AUTH_LDAP_AUTHENTICATION"
    AUTH_LDAP_BASE_CTX_DN="test AUTH_LDAP_BASE_CTX_DN"
    AUTH_LDAP_BASE_FILTER="test AUTH_LDAP_BASE_FILTER"
    AUTH_LDAP_BIND_CREDENTIAL="test AUTH_LDAP_BIND_CREDENTIAL"
    AUTH_LDAP_BIND_DN="test AUTH_LDAP_BIND_DN"
    AUTH_LDAP_CREDENTIALS="test AUTH_LDAP_CREDENTIALS"	
    ...
    AUTH_LDAP_FACTORY="test AUTH_LDAP_FACTORY"
    ...
    AUTH_LDAP_PRINCIPAL="test AUTH_LDAP_PRINCIPAL"
    AUTH_LDAP_PROTOCOL="test AUTH_LDAP_PROTOCOL"
    ...
    AUTH_LDAP_THROW_VALIDATE_ERROR="test AUTH_LDAP_THROW_VALIDATE_ERROR"

 #   AUTH_LDAP_USER_ATTRIBUTE_ID_TO_CHECK="test USER_ID_TO_CHECK"
